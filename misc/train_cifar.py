...
trainset = torchvision.datasets.CIFAR10(root='~/.torch_data', train=True, download=True, transform=transform_train)

trainloader = torch.utils.data.DataLoader(trainset, batch_size=64, shuffle=True, num_workers=2)

testset = torchvision.datasets.CIFAR10(root='~/.torch_data', train=False, download=True, transform=transform_test)
