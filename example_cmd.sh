...
python mask_bn.py --model bagnet17 --datset imagenette --patch_size 32 --cbn #cbn with bagnet17 on imagenette
python mask_bn.py --model bagnet17 --datset imagenette --patch_size 32 --m #mask-bn with bagnet17 on imagenette 
python mask_bn.py --model bagnet17 --datset imagenet --patch_size 32 --cbn #cbn with bagnet17 on imagenet 
python mask_bn.py --model bagnet17 --datset imagenet --patch_size 32 --m #mask-bn with bagnet17 on imagenet
python mask_bn.py --model bagnet17 --datset cifar --patch_size 30 --cbn #cbn with bagnet17 on cifar 
python mask_bn.py --model bagnet17 --datset cifar --patch_size 30 --m #mask-bn with bagnet17 on cifar
#mask-ds and ds
python mask_ds.py --datset imagenette --patch_size 42 --ds #ds for imagenette
python mask_ds.py --datset imagenette --patch_size 42 --m #mask-ds for imagenette
python mask_ds.py --datset imagenet --patch_size 42 --ds #ds for imagenet
python mask_ds.py --datset imagenet --patch_size 42 --m #mask-ds for imagenet
