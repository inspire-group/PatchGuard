...
Update 12/2021: fix a small error in computing lower bound of the true class when the detection threshold T>0. Thank Linyi Li for pointing that out! The mistake does not affect the main results of paper (since the main results are obtained with T=0).
